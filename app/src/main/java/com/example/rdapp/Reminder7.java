...
public class Reminder7 extends AppCompatActivity {
...
*/
        ...
        FirebaseRecyclerOptions<Paid> options =
                new FirebaseRecyclerOptions.Builder<Paid>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("month_entry").orderByChild("Month3").equalTo("7"), Paid.class)
                        .build();
