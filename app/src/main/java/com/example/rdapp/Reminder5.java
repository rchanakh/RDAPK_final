...
public class Reminder5 extends AppCompatActivity {
...
*/
        ...
        FirebaseRecyclerOptions<Paid> options =
                new FirebaseRecyclerOptions.Builder<Paid>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("month_entry").orderByChild("Month3").equalTo("5"), Paid.class)
                        .build();
